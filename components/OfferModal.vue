              ...
              <div>
                ...
                <div class="mt-3 sm:mt-5">
                  <DialogTitle
                    ...
                    >Offer From Waitlist Form</DialogTitle
                  >
                  <div class="mt-2 text-left">
                    ...
                    <textarea
                      type="text"
                      label="Notes"
                      placeholder="Please describe the conversation with the applicant..."
...
const action = ref("Please select an option");
const notes = ref("");
...
const runAction = () => {
  emit("run-action", {
    ...
    ChoiceRank: props.result.ChoiceRank,
