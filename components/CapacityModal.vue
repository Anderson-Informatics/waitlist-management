              ...
              <div>
                ...
                <div class="mt-3 sm:mt-5">
                  <DialogTitle
                    ...
                    >Capacity Update Form</DialogTitle
                  >
                  <div class="mt-2 text-left">
                    ...
                    <p class="mt-3 mb-3">
                      Current capacity: {{ props.item.Capacity }}
                      <br />
                      On waiting list: {{ props.item.OnWaitingList }}
                    </p>
                    <div class="w-full mb-6 md:mb-0">
                      <div class="relative">
                        ...
                        >
                          ...
                          <option>Update capacity</option>
                          <option>Pull one off of waiting list</option>
                        </select>
                        <div
                          class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"
                        ></div>
                        <div v-if="action == 'Update capacity'">
                          <input type="number" v-model="props.item.Capacity" />
                        </div>
                      </div>
                    </div>
                    <textarea
