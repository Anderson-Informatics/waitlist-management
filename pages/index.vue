  ...
  <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Waitlist Management</h2>
        <p class="mt-6 text-lg leading-8 text-gray-300">Just a basic header homepage template for the time being to test the TailwindUI components</p>
      </div>
...
<script setup>
import { TicketIcon, NewspaperIcon, ClipboardDocumentListIcon } from '@heroicons/vue/20/solid'
